...
export class ManagedClustersImpl {
    ...
    listOutboundNetworkDependenciesEndpointsPagingPage(resourceGroupName, resourceName, options, settings) {
        return __asyncGenerator(this, arguments, function* listOutboundNetworkDependenciesEndpointsPagingPage_1() {
            ...
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listOutboundNetworkDependenciesEndpoints(resourceGroupName, resourceName, options));
                const page = result.value || [];
                continuationToken = result.nextLink;
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
            ...
            while (continuationToken) {
                result = yield __await(this._listOutboundNetworkDependenciesEndpointsNext(resourceGroupName, resourceName, continuationToken, options));
                continuationToken = result.nextLink;
                const page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listMeshRevisionProfilesPagingPage(location, options, settings) {
        return __asyncGenerator(this, arguments, function* listMeshRevisionProfilesPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listMeshRevisionProfiles(location, options));
                const page = result.value || [];
                continuationToken = result.nextLink;
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
            ...
            while (continuationToken) {
                result = yield __await(this._listMeshRevisionProfilesNext(location, continuationToken, options));
                continuationToken = result.nextLink;
                const page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listMeshRevisionProfilesPagingAll(location, options) {
        return __asyncGenerator(this, arguments, function* listMeshRevisionProfilesPagingAll_1() {
            var _a, e_4, _b, _c;
            try {
    ...
    listMeshUpgradeProfilesPagingPage(resourceGroupName, resourceName, options, settings) {
        return __asyncGenerator(this, arguments, function* listMeshUpgradeProfilesPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listMeshUpgradeProfiles(resourceGroupName, resourceName, options));
                const page = result.value || [];
                continuationToken = result.nextLink;
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
            ...
            while (continuationToken) {
                result = yield __await(this._listMeshUpgradeProfilesNext(resourceGroupName, resourceName, continuationToken, options));
                continuationToken = result.nextLink;
                const page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listMeshUpgradeProfilesPagingAll(resourceGroupName, resourceName, options) {
        return __asyncGenerator(this, arguments, function* listMeshUpgradeProfilesPagingAll_1() {
            var _a, e_5, _b, _c;
            try {
